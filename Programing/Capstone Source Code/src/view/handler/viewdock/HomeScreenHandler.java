...
public class HomeScreenHandler extends BaseScreenHandler implements Initializable {
    ...
    private void displayDock(Dock dock) {
    }

    private void displayDocks(DockList dockList) {
    ...
    @FXML
    void dockInfoScreenHandler(MouseEvent event) throws IOException
    {
        DockInfoScreenHandler dockInfoScreenHandler = new DockInfoScreenHandler(Configs.DOCK_DETAIL_SCREEN_PATH, this.stage);
        dockInfoScreenHandler.setPreviousScreen(this);
        dockInfoScreenHandler.setHomeScreenHandler(homeScreenHandler);
        dockInfoScreenHandler.setScreenTitle(title: "Dock Infomation");
